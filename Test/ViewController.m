...
- (UIButton *)toolButton {
    if (!_toolButton) {
        ...
        [_toolButton setImage:[[UIImage imageNamed:@"iconfont-cartfill"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
